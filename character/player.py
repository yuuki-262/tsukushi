...
class player(character):
    ...
    def result_move(self, clear_player_position):
        newPosX = self.x - (clear_player_position["x"] - result_player_position["x"]) / 20
        newPosY = self.y - (clear_player_position["y"] - result_player_position["y"]) / 20
        self.x = newPosX
        self.y = newPosY
